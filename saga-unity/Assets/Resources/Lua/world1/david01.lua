...
speak("David", "It's a long story, but I'm after the artifacts of Hero.") 
speak("David", "...Except this place is swarming with bandits and monsters! They have the key here somewhere.")
