...
speak("Seer", "So you're the party that rescued Itamor. He tells me you're looking for parts of EXCALIBER.")
speak(hero1, "We're trying to find the mystic swords before the masters can use it.")
